...
const ORACLE_ADDRESS = "0xe493A54053F230792780997c34332500E64B063d";
...
const Oracle: NextPage = () => {
  ...
  const [templateId, setTemplateId] = useState("2"); // Binary template by default
  // TODO check if this should be a state or a constant
  const [timeout, setTimeout] = useState("86400"); // 24 hours by default
  ...
  const oracles = [
    {
      name: "Reality.eth Oracle V1",
      address: ORACLE_ADDRESS,
      description: "Oracle implementation using Reality.eth for market resolution",
      type: "Precog-Reality",
      version: "1.0.0"
    }
    // Add more oracles here as they become available
  ];
